    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LoyaltyPoints", x => x.PointsId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StoreLogoUrl = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    StoreBannerUrl = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SellerBankInfos", x => x.BankInfoId);
                    table.ForeignKey(
                        name: "FK_SellerBankInfos_SellerProfiles_SellerId",
                        column: x => x.SellerId,
                        principalTable: "SellerProfiles",
                        principalColumn: "SellerId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SellerDocumentId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    SellerId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SellerDocuments", x => x.SellerDocumentId);
                    table.ForeignKey(
                        name: "FK_SellerDocuments_SellerProfiles_SellerId",
                        column: x => x.SellerId,
                        principalTable: "SellerProfiles",
                        principalColumn: "SellerId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SellerReviewId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    SellerId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SellerReviews", x => x.SellerReviewId);
                    table.ForeignKey(
                        name: "FK_SellerReviews_AspNetUsers_CustomerId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FreeShippingAbove = table.Column<decimal>(type: "decimal(10,2)", nullable: true),
                    EstimatedDays = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_SellerShippingRules", x => x.RuleId);
                    table.ForeignKey(
                        name: "FK_SellerShippingRules_SellerProfiles_SellerId",
                        column: x => x.SellerId,
                        principalTable: "SellerProfiles",
                        principalColumn: "SellerId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SubOrders_SellerProfiles_SellerId",
                        column: x => x.SellerId,
                        principalTable: "SellerProfiles",
                        principalColumn: "SellerId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserCouponUsages", x => x.UsageId);
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserCouponUsages_Orders_OrderId",
                        column: x => x.OrderId,
                        principalTable: "Orders",
                        principalColumn: "OrderId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Shippings", x => x.ShipmentId);
                    table.ForeignKey(
                        name: "FK_Shippings_SubOrders_SubOrderId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Wishlists_ProductVariants_ProductVariantVariantId",
                        column: x => x.ProductVariantVariantId,
                        principalTable: "ProductVariants",
                        principalColumn: "VariantId");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Returns_ProductVariants_ExchangeVariantId",
                        column: x => x.ExchangeVariantId,
                        principalTable: "ProductVariants",
                        principalColumn: "VariantId",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SellerId = table.Column<int>(type: "int", nullable: false),
                    OrderItemId = table.Column<int>(type: "int", nullable: false),
                    SaleAmount = table.Column<decimal>(type: "decimal(10,2)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SellerCommissions", x => x.CommissionId);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SellerCommissions_SellerProfiles_SellerId",
                        column: x => x.SellerId,
                        principalTable: "SellerProfiles",
                        principalColumn: "SellerId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Returns_ExchangeVariantId",
                table: "Returns",
                column: "ExchangeVariantId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SellerShippingRules_SellerId",
                table: "SellerShippingRules",
                column: "SellerId");

            migrationBuilder.CreateIndex(
                name: "IX_Shippings_SubOrderId",
                table: "Shippings",
                column: "SubOrderId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SubOrders_OrderId_SellerId",
                table: "SubOrders",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserCouponUsages_UserId_CouponId",
                table: "UserCouponUsages",
                columns: new[] { "UserId", "CouponId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Wishlists_ProductVariantVariantId",
                table: "Wishlists",
                column: "ProductVariantVariantId");
